...
tests, as a result a k-d tree is created before storing the mesh in the scene. \todo{Expand?}
...
queue is empty so as to reduce the number of opengl calls required to update the image. \todo{This could be a little bit clearer}
