...
the photon moves through the media in-between interactions with the media, equation \todo{Add the function and a citation}
...
at each level of the tree the depth of the children differs by at most one, \todo{finish the explanation of the LEFT balanced tree}
...
the median of medians algorithm \todo{cite}. Below is a comparison for the running time of the balancing procedure for
